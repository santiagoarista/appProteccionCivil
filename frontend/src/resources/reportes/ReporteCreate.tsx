...
import { ConditionalNextTabButton } from "./components/ConditionalNextTabButton";
...
export const ReporteCreate = () => {
  ...
  // Transform function to automatically add colaboradorId and turnoId
  const transform = (data: any) => {
    return {
      ...data,
      colaboradorId: permissions?.userId, // Automatically save the user who created it
      turnoId: permissions?.turnoId, // Automatically save the turno
    };
  };
    ...
    <Create transform={transform}>
      <TabbedForm syncWithLocation={false}>
        <FormTab label="Servicio">
          ...
          <ConditionalNextTabButton />
        </FormTab>

        <FormTab label="Reportes urbanos">
          <SelectInput
          ...
          <TextInput
            ...
            label="Tipo de Servicio al que se Acude"
            multiline
            rows={2}
          />
          <SelectInput
          ...
          <TextInput
            ...
            label="Responsables de la Emergencia (responsable del inmueble/zona, etc.)"
            multiline
            rows={2}
          />
        ...
        <FormTab label="Causa (Reporte médico)">
        ...
        <FormTab label="Evaluación (Médico)">
        ...
        <FormTab label="Intervención (Médico)">
          <h3>Tratamiento</h3>
          <CheckboxGroupInput
